...
function mostrarResultadosGuardadas(idGuardadas, guardarlas){
    ...
    if (guardarlas[idGuardadas][0].rol =='dios' && guardarlas[idGuardadas][5].rol =='dios'){
        guardadasResultado.innerHTML='Hay Match'
    recomendacion.innerHTML='🤜🏻Grita full nexo, MVP!🤛🏻'
    } else if (guardarlas[idGuardadas][0].rol=='humano' && guardarlas[idGuardadas][4].rol=='dios'){
        guardadasResultado.innerHTML= 'Hay Match'
        guardadasRecomendacion.innerHTML='🤜🏻Grita full nexo, MVP!🤛🏻'
    } else {
        guardadasResultado.innerHTML='No Hay Match' 
        guardadasRecomendacion.innerHTML='😱Estas AFK!!😱'
    }
